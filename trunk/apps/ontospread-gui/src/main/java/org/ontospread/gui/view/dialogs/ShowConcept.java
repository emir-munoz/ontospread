...
public class ShowConcept extends Dialog {
	...
	protected void createContents() {
		...
		shell.setText(ApplicationResources.getString("ShowConcept.1")); //$NON-NLS-1$

		final Button showButton = new Button(shell, SWT.NONE);
		showButton.setImage(SWTResourceManager.getImage(ShowConcept.class, ApplicationResources.getString("ShowConcept.2"))); //$NON-NLS-1$
		...
		showButton.setText(ApplicationResources.getString("ShowConcept.3")); //$NON-NLS-1$
		showButton.setBounds(442, 22, 88, 23);

		final Button cancelButton = new Button(shell, SWT.NONE);
		cancelButton.setImage(SWTResourceManager.getImage(ShowConcept.class, ApplicationResources.getString("ShowConcept.4"))); //$NON-NLS-1$
		...
		cancelButton.setText(ApplicationResources.getString("ShowConcept.5")); //$NON-NLS-1$
