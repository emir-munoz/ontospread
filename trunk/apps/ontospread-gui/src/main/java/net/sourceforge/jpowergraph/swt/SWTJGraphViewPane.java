 ...
 *
 * $Source: /cvsroot/jpowergraph/swt/src/net/sourceforge/jpowergraph/swt/SWTJGraphViewPane.java,v $,
 * @version $Revision: 1.1 $ $Date: 2006/10/26 18:37:00 $
 */
public class SWTJGraphViewPane extends Composite{
     ...
     * 
     */
    public SWTJGraphViewPane(Composite theParent, Composite theComposite, LensSet theLensSet) {
