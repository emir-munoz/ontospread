...
\begin{abstract}
The present paper~\footnote{This is the short version of the paper, some sections have been dropped in order to adjust the contents to 6 pages. 
The extended version will again include them.} introduces the ONTOSPREAD framework for the development,
