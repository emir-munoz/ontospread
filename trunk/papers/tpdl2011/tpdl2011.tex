...
\ite
In this paper the authors propose an standard and configurable API for SA techniquesm Customization using {\bf distance}: $h_1$ calculates the level activation
